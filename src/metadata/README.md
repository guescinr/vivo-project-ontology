 ...
 * [vivoprojectontology.yml](vivoprojectontology.yml)
     * Determines how your purl.obolibrary.org/obo/vivoprojectontology/ redirects will be handled
     ...
     * Paste in the contents of [vivoprojectontology.yml](vivoprojectontology.yml)
 ...
 * [vivoprojectontology.md](vivoprojectontology.md)
     ...
     * Paste in the contents of [vivoprojectontology.md](vivoprojectontology.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
